...
public class DBConnect {
	...
	public static Connection dbconnect() {
		try {
			...
			Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/collage","root", "type");
			...
			try {
				...
				runner.runScript(new BufferedReader(new InputStreamReader(ClassLoader.class.getResourceAsStream("/Collage.sql"))));
				JOptionPane.showMessageDialog(null, "Database Created...");
				Connection conn1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/collage","root", "type");
				return conn1;
			} catch (Exception e1) {
				e1.printStackTrace();
				return null;
